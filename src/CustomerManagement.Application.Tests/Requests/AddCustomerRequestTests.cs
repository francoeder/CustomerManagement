...
{
    public class AddCustomerRequestTests : IClassFixture<BaseFixture>
    {
        private readonly BaseFixture _fixture;

        public AddCustomerRequestTests(BaseFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        {
            // Arrange
            var request = _fixture.Fixture.Build<AddCustomerRequest>()
                .Without(request => request.CompanyName)
            ...
            Assert.Collection(errorMessages,
                error => Assert.Equal(ValidationMessages.Customer.CompanyNameEmpty, error.ErrorMessage),
        ...
        public void IsValid_WhenAllPropertiesAreCorrect_ShouldReturnTrue()
        {
            // Arrange
            var request = _fixture.Fixture.Build<AddCustomerRequest>()
                .With(request => request.CompanyName, "Wayne Corp.")
